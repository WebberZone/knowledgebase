...
class Media_Handler {
	 ...
	 * @var string
	 */
	protected static $default_thumb_url = WZKB_DEFAULT_THUMBNAIL_URL;
	...
	protected static function ensure_loading_and_decoding_attrs( array $attr ): array {
		if ( empty( $attr['loading'] ) ) {
			/**
			 * Filters the default loading attribute applied to Knowledge Base thumbnails.
			 *
			 * @since 3.0.0
			 *
		...
		if ( empty( $attr['decoding'] ) ) {
			/**
			 * Filters the default decoding attribute applied to Knowledge Base thumbnails.
			 *
			 * @since 3.0.0
			 *
